...
function getCompletedTodos() {
    ...
    $.ajax({
        type: "GET",
        url: server + "todos", // endpoint to get all completed todo
        async: false,
...
function getIncompleteTodos() {
    ...
    $.ajax({
        type: "GET",
        url: server + "todos/incomplete", // endpoint to get all incompleted todo
        async: false,
        success: function(data) {
            result = data.data;
        }
...
function addItemToBackend(value) {
    ...
    $.ajax({
        type: "POST",
        url: server + "todos", // endpoint to add todo
        data: JSON.stringify(
            payload
        ),
        cache: false,
        ...
        async: false,
        success: function(data) {
            result = data.data; // TODO: return last added id
            console.log(data);
        }
    });
    return result.id;
...
function removeItemInBackend(id, value) {
    $.ajax({
        url: server + "todos/" + id, // TODO: change value to id
        type: 'DELETE',
        data: {},
        cache: false,
        dataType: "JSON",
...
function updateBackendItem(id, value, status) {
    payload = { 'title': value, 'status': status };
    $.ajax({
        url: server + "todos/" + id, // TODO: change value to id
        type: 'PUT',
        data: JSON.stringify(
